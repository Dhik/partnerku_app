...
return [
    ...
    'logo_help' => 'Upload an image file (JPEG, PNG, JPG, GIF, SVG). Maximum size: 2MB.',
    'logo_help_update' => 'Upload a new image to replace the current logo. Leave empty to keep current logo.',
];
