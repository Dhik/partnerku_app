...
<script>
    $(() => {
        ...
        // Add support to auto select the previous submitted value in case of validation errors.
...
<style type="text/css">
    ...
    .partner-invalid-iswgroup > .bootstrap-switch-wrapper,
    .partner-invalid-iswgroup > .input-group-prepend > *,
    .partner-invalid-iswgroup > .input-group-append > * {
