...
<li class="{{ $makeListItemClass() }}" id="{{ $id }}">
    ...
    @if($enableDropdownMode)
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="partner-dropdown-content"></div>
...
<script>
    $(() => {
        ...
        let updateNotification = (nLink) => {
            // Make an ajax call to the configured url
            $.ajax({
                url: "{{ $makeUpdateUrl() }}"
            })
            .done((data) => {
        ...
        let nLink = new _Partner_NavbarNotification("{{ $id }}");
...
@push('js')
<script>
    class _Partner_NavbarNotification {
        /**
         * Constructor.
         */
        constructor(target) {
        ...
        update(data) {
            ...
            let dropdown = t.find(".partner-dropdown-content");
